...
#***************init capteur i2c ************
i2c = I2C(0, sda=Pin(21), scl=Pin(23), freq=400000)
...
timer_period_ms, error_period_ms = 5000, 2000	# Fréquence de mesure normale / erreur détectée
    ...
    if reception_flag :
        ...
        if isinstance(trame, dict):
            ...
            if mesure_hauteur == 1:
                hauteur = use_data()
                mesure_hauteur = 0
            trame_recu = lora_barrage.get_trame(hauteur)
            lora_barrage.envoyer_trame(addr_high_pupitre, addr_low_pupitre, CANAL, trame_recu)
