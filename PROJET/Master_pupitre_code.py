...
# Adresse du module Lora sur le barrage xxxxxxxxxxxx
...
while True:
    if emission_flag:
        print(Color.G)
        lora_pupitre.envoyer_trame(addr_high_barrage, addr_low_barrage, CANAL) #envoyer_trame(self, addr_high, addr_low, CANAL):
        ...
        if reception_flag :
            print(Color.Y)
            trame = lora_pupitre.lecture_trame()
